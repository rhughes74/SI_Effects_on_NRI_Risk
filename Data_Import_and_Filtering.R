...
#Save Final Result
saveRDS(Filtered_Dataset, "Datasets/Filtered_Dataset.rds")
saveRDS(Filtered_Dataset_den, "Datasets/Filtered_Dataset_den.rds")
saveRDS(Filtered_Dataset_aden, "Datasets/Filtered_Dataset_aden.rds")
#------------------------------------------------------------------------------------------------------------------------------------------------------------
...
save.image("Datasets/LoadedData.RData")
