...
data1 = read_rds("Datasets/Filtered_Dataset.rds")  %>%
...
data2 = read_rds("Datasets/Filtered_Dataset_den.rds") %>% 
...
data3 = read_rds("Datasets/Filtered_Dataset_aden.rds") %>%
...
# evaluate ############################################
data = read_rds("Datasets/data.rds")
